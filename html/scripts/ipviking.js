...
(function(window) {
  ...
  // var width = window.innerWidth,
    ...
    var width = document.getElementById('parent-element').offsetWidth;
    var height = document.getElementById('parent-element').offsetHeight;
  ...
  (function() {
    ...
    clusters.append("h4").text("this is attack origin");
    ...
    countryColors.append("h4").text("Target");
  ...
  queue()
    ...
    .await(function(error, world, rawPorts, countryCodes) {
      ...
      svg.append("g")
        ...
        .attr("fill", settings.countryColor(2))
        .attr("d", path);
